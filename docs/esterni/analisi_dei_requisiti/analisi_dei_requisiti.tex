...
\paragraph{UC2 - Connessione wallet (webapp venditore)}\\
\textbf{Attore primario}: Venditore con wallet non connesso.\\
\textbf{Attore secondario}: Metamask.\\
\textbf{Precondizioni}: Il venditore ha aperto la webapp e non ha ancora connesso il wallet con Metamask.\\
\textbf{Postcondizioni}: Il venditore ha connesso il wallet con Metamask e accede al sistema.\\
\textbf{Scenario principale}:
\begin{enumerate}
    \item il venditore apre la webapp;
    \item il venditore connette tramite Metamask il proprio wallet;
    \item il venditore accede al sistema.
\end{enumerate}
\textbf{Estensioni}:
\begin{enumerate}
    \item UC2.1 Metamask genera un errore durante la procedura.
    \begin{enumerate}
        \item il sistema mostra l'errore connessione wallet non riuscita;
...
\textbf{Attore secondario}: Metamask.\\
\textbf{Precondizioni}: L'acquirente ha aperto la landing page.\\
\textbf{Postcondizioni}: L'acquirente connette il wallet tramite Metamask e accede al sistema.\\
\textbf{Scenario principale}:
\begin{enumerate}
    \item l’utente apre la landing page;
    \item l’utente connette tramite Metamask il proprio wallet;
    \item l’utente accede al sistema.
\end{enumerate}
\textbf{Estensioni}:
\begin{enumerate}
    \item UC11 Metamask genera un errore durante la procedura di connesione del wallet:
    \begin{enumerate}
        \item il sistema mostra l'errore connesione wallet non riuscita;
        \item il sistema mostra il messaggio riprovare;
...
\textbf{Precondizioni}: L'acquirente ha acceduto al sistema e ha connesso un wallet.\\
\textbf{Postcondizioni}: Il sistema mostra il riepilogo dell'ordine.\\
\textbf{Scenario principale}:
\begin{enumerate}
    \item l’utente accede al sistema con un wallet connesso;
...
\textbf{Attore primario}: Acquirente senza wallet connesso.\\
\textbf{Attore secondario}: Metamask.\\
\textbf{Precondizioni}: L'acquirente ha aperto la webapp e non ha ancora connesso il wallet con Metamask.\\
...
\begin{enumerate}
    ...
    \item l'acquirente connette tramite Metamask il proprio wallet;
    \item l’acquirente ha connesso un wallet e accede al sistema.
\end{enumerate}
\textbf{Estensioni}:
\begin{enumerate}
    \item UC18 Metamask genera un errore durante la procedura di connessione del wallet:
    \begin{enumerate}
        \item il sistema mostra l'errore connessione wallet non riuscita;
        \item il sistema mostra il messaggio riprovare;
