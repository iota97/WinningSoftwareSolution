...
\addversione{0.1.0}{13/04/2022}{Federico Marchi}{Matteo Galvagni}{Stesura iniziale}
...
\end{itemize}
Una volta che si viene reindirizzati alla landing page e che si ha verificato di possedere una sufficiente quantità di MATIC si può procedere col pagamento. \`E possibile verificare prima del pagamento l'ammontare in dollari e l'address del venditore (Fig. 2). Infine per concludere il pagamento:
\begin{itemize}
...
\begin{itemize}
\item selezionare ``Confirm" (Fig. 5);
