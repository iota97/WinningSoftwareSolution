...
\subsubsection{Testing}
I test vengono eseguiti attraverso le funzioni nel file \texttt{test\_sell.py}. I test coprono sia un caso di successo, sia un caso di fallimento. I test eseguono sia lo script simulando una linea di comando, sia importando la funzione \texttt{sell\_item} ed eseguendola.
