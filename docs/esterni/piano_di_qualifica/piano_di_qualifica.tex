...
\addversione{2.1.0}{30/03/2021}{Giovanni Cocco}{Redazione}{Aggiornamento per ciclo 1.}
...
\subparagraph{Struttura del grafico:}
Ogni punto indica la variazione del consultivo rispetto al preventivo di un ciclo di sprint.
