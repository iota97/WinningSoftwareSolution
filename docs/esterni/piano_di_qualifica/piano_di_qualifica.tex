...
Per alcune settimane nono sono stati effettuati test su alcuni prodotti software; questo perché non sono state effettuate modifiche. Ciò potrebbe dare l'impressione al proponente che la qualità di tali prodotti non sia garantita, riflettendo negativamente sull'operato del gruppo WSWS.
