...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \textbf{Problema} & \textbf{Soluzione adottata}\\
        \hline
        Durante la presentazione al proponente è i pagamenti non sono andato a buon fine. & Si è deciso di individuare la causa in una riunione straordinaria a fine dell'incontro. La causa è stata individuata in un downtime dell'RPC della testnet impostato in MetaMask. Cambiando l'RPC si ovvia al problema. \\
        \hline
