...
\addversione{2.12.0}{07/05/2022}{Alberto Nicoletti}{Elia Scandaletti}{Aggiunta analisi narrativa dello stato d'avanzamento.}
\addversione{2.13.0}{08/05/2022}{Elia Scandaletti}{Andrea Volpe}{Aggiunto preventivo per ciclo 7.}
\addversione{2.14.0}{11/05/2022}{Elia Scandaletti}{Giovanni Cocco}{Chiusura ciclo 7.}
...
\ganttgroup[progress=100]{CA}{2022-04-07}{2022-05-12} \\
\ganttbar[progress=100]{Manuale Installazione}{2022-03-30}{2022-05-12} \\
\ganttbar[progress=100]{Completamento WebApp}{2022-04-14}{2022-05-04} \\
\ganttbar[progress=100]{Validazione}{2022-05-04}{2022-05-11}
\end{ganttchart}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|X|X|}
        ...
        \hline
        Responsabile    & 30 & 82  & 2460\\
        \hline
        Amministratore  & 20 & 91  & 1820\\
        \hline
        Analista        & 25 & 101.5  & 2537.5 \\
        \hline
        Progettista     & 25 & 109  & 2725\\
        \hline
        Programmatore   & 15 & 216.5  & 3247.5\\
        \hline
        Verificatore    & 15 & 95  & 1425 \\
        \hline
        \hline
        \textbf{Totale} &    & 695 & 14215\\
        \hline
    \end{tabularx}\\[8pt]
    \mbox{}\\
\end{center}
...
Il progetto è da considerarsi terminato, per questo motivo non sono preventivate ulteriori ore.
Il tempo necessario alle comunicazioni tra gruppo, proponente e committente è ritenuto trascurabile.

\textbf{Data di fine prevista}: 12 Maggio 2022 \\
\textbf{Data di fine effettiva}: 12 Maggio 2022

\subsection{Stato d'avanzamento corrente}
La data di consegna è posticipata di due settimane rispetto al preventivo iniziale. Tale scadenza è stata rispettata. In quella data viene richiesto il colloquio CA. \\
Con la richiesta di colloquio CA si prevede di venire a conoscenza dei contenuti della relativa presentazione. Non appena saranno resi noti si inizierà la preparazione per il colloquio. \\
Il prodotto software è completo in tutte le sue parti. La validazione del prodotto è stata completata con successo. Non sono state rilevate criticità. \\
I manuali sono completi. \\
La documentazione è stata aggiornata in linea con la valutazione PB del prof. Vardanega. \\
...
\subsection{Sprint 7}
\textbf{Data di inizio:} 04-05-2022\\
\textbf{Data di fine pianificata:} 11-05-2022\\
\textbf{Data di fine effettiva:} TBD
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \textbf{Item} & \textbf{Persone richieste}\\
        \hline
        Aggiornamento cronologia delle modifiche dei documenti. & 1\\
		\hline
        Modificare SCRUM in Scrum. & 1\\
		\hline
        Completamento manuali. & 1\\
		\hline
        Analisi narrativa d'insieme Piano di Progetto. & 1\\
		\hline
        Analisi narrativa d'insieme Piano di Qualifica. & 1\\
		\hline
        Sistemazione cartella public come da esito PB. & 1\\
		\hline
        Aggiornamento NdP come da verbale del 04/05. & 1\\
		\hline
        Validazione. & 3\\
		\hline
    \end{tabularx}\\[8pt]
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \textbf{Problema} & \textbf{Misure di mitigazione}\\
        \hline
        È prevista una riunione con il proponente. Potrebbe non essere soddisfatto del lavoro svolto finora e potrebbe richiedere modifiche al prodotto. & Non sono previste misure di mitigazione da applicare in questo ciclo. Questo perché la mitigazione di questo rischio dev'essere una conseguenza del Way of Working.\\
        \hline
        Durante l'attività di validazione potrebbero emergere dei requisiti non rispettati o non completamente soddisfatti. & Non sono previste misure di mitigazione da applicare in questo ciclo. Questo perché la mitigazione di questo rischio dev'essere una conseguenza del Way of Working.\\
        \hline
    \end{tabularx}\\[8pt]
    \mbox{}\\
\end{center}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|X|X|}
        ...
        Progettista     & 25 & 0 (-2) & 0 (-50)\\
        \hline
        Programmatore   & 15 & 18 (-2)  & 270 (-30)\\
        \hline
        Verificatore    & 15 & 28 (+3)  & 420 (+45)\\
        \hline
        \hline
        \textbf{Totale} &    & 56 (-4) & 930 (-115)\\
        \hline
    \end{tabularx}\\[8pt]
    \mbox{}\\
\end{center}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \textbf{Problema} & \textbf{Soluzione adottata}\\
        \hline
        Durante la presentazione al proponente alcune transazioni non sono andate a buon fine. & Si è deciso di individuare la causa in una riunione straordinaria a fine dell'incontro. La causa è stata individuata in un downtime dell'RPC della testnet impostato in MetaMask. Cambiando l'RPC si ovvia al problema. \\
        \hline
        Durante la riunione straordinaria, è emerso un problema che provoca occasionalmente il crash del server a causa di interruzioni alla connessione socket dal lato di Moralis. & Per ovviare a questi rari casi, poiché modificare l'architettura costerebbe troppo, si è optato per un riavvio automatico del server. \\
        \hline
    \end{tabularx}\\[8pt]
    \mbox{}\\
\end{center}
...
\begin{center}
    \begin{tabularx}{\textwidth}{|X|X|}
        ...
        \textbf{Nozione} & \textbf{Conseguenza sulla pianificazione}\\
        \hline
        Potrebbe capitare che ci siano imprevisti tecnici con la testnet durante la presentazione. & Bisogna avere più di una persona pronta ad esporre in caso una persona abbia problemi improvvisi. Bisogna avere pronte delle RPC di riserva in caso di downtime di quella in uso durante la presentazione. \\
        \hline
    \end{tabularx}\\[8pt]
    \mbox{}\\
\end{center}
