...
\begin{itemize}
  ...
  \item \textbf{Expire:} indica la data di scadenza dell'ordine (14 giorni dalla data di acquisto), al raggiungimento di questa data i fondi verranno automaticamente sbloccati e saranno resi disponibili all'e-commerce;
