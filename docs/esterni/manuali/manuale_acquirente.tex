...
Per ciascun acquisto l'acquirente ha 14 giorni per annullare il pagamento e dunque essere rimborsato con la valuta stabile DAI. Nel caso l'utente voglia annullare il pagamento dovrà selezionare l'opzione "Refund transaction" (Fig. 4 riquadro 2) e dunque ricevere il rimborso.
\end{itemize}
\FloatBarrier
\begin{figure}[!h]
\centering
