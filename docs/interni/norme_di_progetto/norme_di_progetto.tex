...
\setredattori{Elia Scandaletti \\ Raffaele Oliviero \\ Giovanni Cocco \\ Alberto Nicoletti \\ Matteo Galvagni \\ Andrea Volpe}
\setdestuso{interno}
\setdescrizione{
Questo documento contiene le procedure, gli strumenti e i criteri di qualità che verranno usati nel progetto.
}

\addversione{0.0.0}{13/11/2021}{Elia Scandaletti}{Giovanni Cocco}{Stesura documentazione.}
\addversione{0.0.1}{14/11/2021}{Elia Scandaletti}{Giovanni Cocco}{Stesura configurazione Github.}
\addversione{0.0.2}{07/12/2021}{Elia Scandaletti}{Giovanni Cocco}{Inserimento norme da verbale del 01/12/2021.}
\addversione{0.0.3}{22/12/2021}{Elia Scandaletti}{Giovanni Cocco}{Stesura regole stesura verbali.}
\addversione{0.0.4}{09/01/2022}{Raffaele Oliviero}{Giovanni Cocco}{Ristrutturazione documento.}
\addversione{0.0.5}{09/01/2022}{Raffaele Oliviero}{Giovanni Cocco}{Stesura struttura del piano di qualifica e della verifica e validazione.}
\addversione{0.0.6}{16/01/2022}{Elia Scandaletti}{Giovanni Cocco}{Adeguamento di verifica e validazione secondo decisioni collettive.}
\addversione{0.0.7}{04/02/2022}{Giovanni Cocco}{Elia Scandaletti}{Stesure delle revisioni di avanzamento interne.}
\addversione{0.0.8}{08/02/2022}{Raffaele Oliviero}{Elia Scandaletti}{Stesura di: analisi dei requisiti, analisi delle tecnologie e piano di progetto.}
\addversione{0.0.9}{16/02/2022}{Giovanni Cocco}{Elia Scandalett}{Stesura di norme software.}
\addversione{2.0.0}{20/03/2022}{Alberto Nicoletti}{Raffaele Oliviero}{Rifacimento documento completo.}
\addversione{2.0.1}{17/04/2022}{Elia Scandaletti}{Raffaele Oliviero}{Aggiornamento processo fornitura.}
\addversione{2.0.2}{18/04/2022}{Elia Scandaletti}{Giovanni Cocco}{Correzione grammatica.}
\addversione{2.0.3}{07/05/2022}{Matteo Galvagni}{Elia Scandaletti}{Correzione dopo revisione PB.}
\addversione{2.1.0}{08/05/2022}{Andrea Volpe}{Raffaele Oliviero}{Aggiornamento verbali e processi organizzativi.}
\addversione{2.1.1}{10/05/2022}{Elia Scandaletti}{Andrea Volpe}{Correzione processo fornitura dopo revisione PB.}
...
Ogni documento che prevede versionamento deve indicare la versione nel nome del file stesso nel seguente modo: \texttt{$<$NomeFile$>$\_v$<$versione$>$.pdf}. I documenti con le versioni vecchie andranno rimossi. \\
...
\item Riassunto dei contenuti / Svolgimento (per verbale chiusura ciclo di sprint);
...
\subparagraph{Dettagli}\label{documentazione-documenti-verbali-dettagli}
In caso di verbale di chiusura di ciclo di sprint, la parte di \textit{svolgimento} dovrà essere strutturata nel seguente modo:
\begin{itemize}
	\item Resoconto del ciclo di sprint precedente
	\item Criticità del ciclo di sprint precedente
	\item Task per il ciclo di sprint successivo:
    \begin{itemize}
		\item Indicare il responsabile per il ciclo di sprint successivo
		\item Elencare le attività numerate con il corrispondente id della issue su GitHub
	\end{itemize}
\end{itemize}
...
Gli item pianificati non potranno subire modifiche o cancellazioni durante il ciclo di sprint e dovranno essere portati a termine
entro il ciclo successivo. In caso emergessero importanti contestazioni o criticità il responsabile deciderà come agire.\\
