...
const onClickSettlePayment = () => {  
    ...
    if(intId == 80001){ //the contract is deployed only in mumbai testnet        
        ...
        .then(paymentEntry => {  
            console.log(conversion+"*"+paymentEntry.price)          
